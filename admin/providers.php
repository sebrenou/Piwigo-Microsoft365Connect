...
load_language('help.lang', M365CONNECT_PATH);

$PROVIDERS_CONFIG = include(M365CONNECT_PATH . 'include/providers_stats.inc.php');
...
if (isset($_POST['save_config']))
{
  ...
  if (!count($page['errors']))
  {
    ...
    file_put_contents(M365CONNECT_CONFIG, $content);
...
$template->set_filename('m365connect_content', realpath(M365CONNECT_PATH . 'admin/template/providers.tpl'));
