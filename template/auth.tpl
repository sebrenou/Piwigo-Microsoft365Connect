...
{if $ERROR}
  <img id="loader" src="{$M365CONNECT_PATH}template/images/alert.png">
...
{elseif $LOADING}
  <img id="loader" src="{$M365CONNECT_PATH}template/images/ajax-loader-big.gif">
...
{elseif $REDIRECT_TO}
  <script type="text/javascript"> 
    if (window.opener) 
    {
      window.opener.parent.m365connect_redirect('{$REDIRECT_TO}');
    } else {
      url = '{$ABS_ROOT_URL}'+ 'index.php';       
